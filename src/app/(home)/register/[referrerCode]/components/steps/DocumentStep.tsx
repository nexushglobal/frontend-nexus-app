...
import { validateDocument } from "../../actions/register-actions";
import {
    DocumentStepData,
    documentStepSchema,
    documentTypes,
    ...
    const onSubmit = (data: DocumentStepData) => {
        startTransition(async () => {
            if (data.documentType === "DNI") {
                try {
                    const result = await validateDocument(data.documentNumber, "dni");
                    ...
                    if (result.success && result.data) {
                        ...
                        onNext(data, {
                            ...
                            lastName: `${result.data.fathers_lastname} ${result.data.mothers_lastname}`.trim(),
                        });
                    } else {
                    ...
                    toast.error("Error", {
                        description: "Error al validar el documento. Continuando sin validación.",
                    });
                    onNext(data, null);
                }
            } else {
                    ...
                    {form.watch("documentType") === "DNI" && (
                        <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                            <p className="text-sm text-blue-700 dark:text-blue-300">
                                <strong>Validación automática:</strong> Al continuar, validaremos tu DNI
                                automáticamente y completaremos tus datos personales si los encontramos.
                            </p>
                        </div>
                    )}
