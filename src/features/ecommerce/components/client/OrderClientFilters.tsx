...
interface OrderClientFiltersProps {
  isLoading?: boolean;
}

export function OrderClientFilters({
  isLoading = false,
}: OrderClientFiltersProps) {
  const { filters, setFilter, resetFilters } = useOrderClientFiltersStore();
