...
import { MembershipPlan, UserMembership } from "@/features/membership/types/membership-detail.type";
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <h1 className="text-2xl font-bold text-foreground">Plan {plan.name}</h1>
                ...
                {userMembership.hasMembership && (
                    <div className="bg-muted/50 rounded-lg p-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Plan {userMembership.plan?.name} • {formatCurrency(userMembership.plan?.price || 0)}
                        </p>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="info-field">
                            ...
                            <div>
                                ...
                                <div className="text-xs text-muted-foreground">Monto de verificación</div>
                            </div>
                        </div>
                        ...
                        <div className="info-field">
                            ...
                            <div>
                                <div className="font-semibold">{plan.binaryPoints.toLocaleString()}</div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div>
                                <h3 className="font-semibold">
                                    {userMembership.hasMembership ? "Actualizar tu membresía" : "Adquirir este plan"}
                                </h3>
                                <p className="text-sm text-muted-foreground">
