...
export function VoucherPaymentModal({
    ...
    const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (selectedFile) {
            ...
            if (!selectedFile.type.startsWith('image/')) {
                setErrors(prev => ({ ...prev, file: 'Solo se permiten archivos de imagen' }));
                return;
            }

            // Validate file size (5MB max)
            if (selectedFile.size > 5 * 1024 * 1024) {
                setErrors(prev => ({ ...prev, file: 'El archivo no puede ser mayor a 5MB' }));
                return;
            }
    ...
    const validateForm = () => {
        ...
        if (!formData.transactionReference.trim()) {
            newErrors.transactionReference = 'La referencia de transacción es requerida';
        }
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            className={errors.transactionReference ? 'border-destructive' : ''}
                        />
