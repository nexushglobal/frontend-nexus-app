...
import { RejectPaymentRequest } from "@/features/payment/types/approval.type";

const rejectPaymentSchema = z.object({
    rejectionReason: z.string().min(10, "La razón de rechazo debe tener al menos 10 caracteres"),
});
