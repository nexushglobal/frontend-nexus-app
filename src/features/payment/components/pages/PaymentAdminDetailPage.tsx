...
async function PaymentAdminDetailData({ paymentId }: { paymentId: string }) {
    ...
    return <PaymentAdminDetailContent payment={result.data} paymentId={paymentId} />
}

export function PaymentAdminDetailPage({ paymentId }: PaymentAdminDetailPageProps) {
    return (
