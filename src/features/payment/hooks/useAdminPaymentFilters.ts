...
interface UseAdminPaymentFiltersProps extends PaymentSearchParams {}

export function useAdminPaymentFilters(props: UseAdminPaymentFiltersProps) {
  ...
  const handleSortChange = useCallback(
    (value: string) => {
      ...
      // Auto toggle sort order when changing sort field
