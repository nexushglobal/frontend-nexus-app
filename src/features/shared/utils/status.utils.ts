...
export function getStatusConfig(status: PaymentStatus | WithdrawalStatus | OrderStatus | VolumeStatus | TransactionStatus | ProductStatus | BannerStatus): StatusConfig {
