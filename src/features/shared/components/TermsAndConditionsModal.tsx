    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Por favor lee detenidamente nuestros términos y condiciones antes de
        ...
        <div className="mt-4 space-y-3">
          <div className="flex items-start space-x-3 p-3 bg-primary/5 border border-primary/20 rounded-lg">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Al marcar esta casilla, confirmas que has leído y aceptas los
                términos y condiciones de Nexus H. Global.
              </p>
            </div>
          </div>
          ...
          {showError && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Debes aceptar los términos y condiciones para continuar con el
                registro.
              </AlertDescription>
            </Alert>
          )}
