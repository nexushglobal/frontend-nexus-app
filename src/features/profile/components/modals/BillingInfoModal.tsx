      ...
      try {
        ...
        if (result.success) {
          toast.success('Información actualizada', {
            description:
              'Tu información de facturación se ha actualizado correctamente',
          });
          setOpen(false);
          onUpdate();
        } else {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Alert className="border-info/20 bg-info/5">
          ...
          <AlertDescription className="text-sm">
            <strong>Información opcional:</strong> Completa estos datos solo si
            requieres facturación empresarial o comprobantes fiscales.
          </AlertDescription>
        </Alert>
